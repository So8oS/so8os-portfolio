    ...
    return (
     ...
     >
        ...
        <form className="flex flex-col  items-center gap-12 " ref={form} onSubmit={sendEmail}>
                ...
                <input className="  border border-gray-600 rounded-[0.625rem]  w-[18rem] h-[3.375rem] md:w-[27.25rem] p-2 dark:bg-[#3B3B3B] dark:text-white " type="text" name="user_name" placeholder='Name' required />
                <input className=" border border-gray-600 rounded-[0.625rem] w-[18rem] h-[3.375rem] md:w-[27.25rem] p-2  dark:bg-[#3B3B3B] dark:text-white  " type="email" name="user_email" placeholder='Email' required />
